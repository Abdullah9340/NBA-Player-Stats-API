...
class AllTimeLeadersGrids(Endpoint):
    ...
    def load_response(self):
        ...
        self.data_sets = [Endpoint.DataSet(
            data=data_set) for data_set_name, data_set in data_sets.items()]
        ...
        self.fg3_pct_leaders = Endpoint.DataSet(
            data=data_sets['FG3_PCTLeaders'])
